...
def generate_chat_response(input, chat_history):
    ...
    input_messages = []
    user_content = []
    input_messages.append({"role": "system", "content": "You are a helpful assistant."})
    ...
    if chat_history is not None:
        for message in chat_history:
            input_messages.append({"role": "user", "content": message[0]})
            input_messages.append({"role": "assistant", "content": message[1]})
